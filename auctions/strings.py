...
MESSAGE_LISTING_EDIT_SUCCESSFUL = "Listing {} has been successfully edited."
...
MESSAGE_LISTING_DELETE_PROHIBITED = ("You are not allowed to delete this listing.")
MESSAGE_LISTING_EXPIRED = ("This listing has expired.")

# User index messages
MESSAGE_USER_LISTING_DELETED = "Listing \"{}\" has been deleted."
MESSAGE_USER_LISTING_EDIT_PROHIBITED = ("Listing \"{}\" cannot be edited. This is either "
